...
public class WithdrawPendingHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_withdraw_pending_history, container, false);
        ...
        call.enqueue(new Callback<PendingWithdrawsResponseModel>() {
            ...
            public void onResponse(Call<PendingWithdrawsResponseModel> call, Response<PendingWithdrawsResponseModel> response) {
                ...
                if (status == 200) {
                    ...
                    list = response.body().getPendingDataModels();
